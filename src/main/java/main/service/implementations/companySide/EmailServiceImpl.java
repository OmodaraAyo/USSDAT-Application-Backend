...
public class EmailServiceImpl implements EmailService {
    ...
    @Async
    @Override
    public void sendEmail(String companyName, String registeredCompanyEmail, String generatedPassword) {
        try{
            ...
            String htmlContent ="<!DOCTYPE html>" +
                    ...
                    "<ul>" +
                    "<li>A dedicated USSD path under our shared shortcode</li>" +
                    ...
                    "<p>Log in at: <a href=\"https://backwyth.onrender.com/\" target=\"_blank\" rel=\"noopener noreferrer\">backwyth.com</a></p>" +
                    "<p>Need help getting started? Check out our <a href=\"https://github.com/Backwyth/Backwyth/Docs\" target=\"_blank\" rel=\"noopener noreferrer\">Docs</a> or reach out to our team — we're here to support you.</p>" +
                    "<p>Welcome aboard,</p>" +
